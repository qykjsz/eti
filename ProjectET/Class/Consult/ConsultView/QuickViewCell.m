...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *timeLabel = [ClassBaseTools labelWithFont:11 textColor:[UIColor whiteColor] textAlignment:1];
        ...
        UILabel *titleName = [ClassBaseTools labelWithFont:15 textColor:[UIColor blackColor] textAlignment:0];
