...
@interface ETKeystoreQcodeView()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ETKeystoreQcodeView
...
//    [garyView addSubview:btn];
    ...
    self.qcodeImage = [[UIImageView alloc]initWithImage:[KMPQRCodeManager createQRCode:model.keyStore warterImage:nil]];
