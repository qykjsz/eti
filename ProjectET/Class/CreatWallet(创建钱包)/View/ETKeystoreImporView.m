...
@interface ETKeystoreImporView()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ETKeystoreImporView
...
- (UIView *)footerView {
    ...
    self.syao.text = @"UIView *view = [[UIView alloc] init];view.frame =CGRect Make(16";
    ...
    [copyBtn setTitle:@"复制Keystore" forState:UIControlStateNormal];
...
- (void)copyAction {
   ...
   [Tools copyClickWithText:model.keyStore];
