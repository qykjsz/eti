...
+(void)hs_sendToAssress:(NSString *)toAddress ip:(NSString *)ip money:(NSString *)money tokenETH:(NSString *)tokenETH decimal:(NSString *)decimal currentKeyStore:(NSString *)keyStore pwd:(NSString *)pwd gasPrice:(NSString *)gasPrice gasLimit:(NSString *)gasLimit block:(void(^)(NSString *hashStr,BOOL suc,HSWalletError error))block{
    ...
    __block JsonRpcProvider *e =[[JsonRpcProvider alloc]initWithChainId:ChainIdHomestead url:[[NSURL alloc]initWithString:ip]];
