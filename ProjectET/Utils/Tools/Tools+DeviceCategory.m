...
+ (void)saveDeviceInfo {
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone 4"] ||
        [[Tools getCurrentDeviceModel] isEqualToString:@"iPhone 4s"] ) {
        
        //320*480
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 4" forKey:@"DeviceName"];
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone 5"] ||
        ...
        //320*568
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 5" forKey:@"DeviceName"];
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone 6"] ||
        ...
        //375*667
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 6" forKey:@"DeviceName"];
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone 6 Plus"] ||
        ...
        //417*736
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 6 Plus" forKey:@"DeviceName"];

    }

    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone X"] ||
        [[Tools getCurrentDeviceModel] isEqualToString:@"iPhone XS"]) {
        
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone X" forKey:@"DeviceName"];
        
    }
    
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone XR"]) {
        
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone XR" forKey:@"DeviceName"];
    }
    
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone XS Max"]) {
        
        [[NSUserDefaults standardUserDefaults] setObject:@"iPhone XS Max" forKey:@"DeviceName"];
    }
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPad 2"] ||
        ...
        //768*1024
        [[NSUserDefaults standardUserDefaults] setObject:@"iPad" forKey:@"DeviceName"];
    ...
    if ([[Tools getCurrentDeviceModel] isEqualToString:@"iPhone Simulator"]) {
        ...
        if ([UIScreen mainScreen].currentMode.size.height == 2688) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone XS Max" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 2436) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone X" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 1792) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone XR" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 2208) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 6 Plus" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 1334) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 6" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 1136) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 5" forKey:@"DeviceName"];
        }
        else if ([UIScreen mainScreen].currentMode.size.height == 960) {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone 4" forKey:@"DeviceName"];
        }
        else {
            [[NSUserDefaults standardUserDefaults] setObject:@"iPhone X" forKey:@"DeviceName"];
